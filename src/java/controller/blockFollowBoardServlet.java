 ...
 * @author louisacheong
 */
@WebServlet(name = "blockFollowBoardServlet", urlPatterns = {"/blockFollowBoard"})
public class blockFollowBoardServlet extends HttpServlet {
