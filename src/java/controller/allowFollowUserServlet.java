 ...
 * @author louisacheong
 */
@WebServlet(name = "allowFollowUserServlet", urlPatterns = {"/allowFollowUser"})
public class allowFollowUserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        UFUentry.setIsPermitted(true);
        System.out.println(UFUentry.getIsPermitted());
        UserFollowsUserFacade.edit(UFUentry);
        List<UserFollowsUser> numFollower = UserFollowsUserFacade.findByPersonBeingFollowedandisPermitted(beingFollowed, Boolean.TRUE);
        Integer followerCount = numFollower.size();
        session.setAttribute("followerCount",followerCount);
        List<UserFollowsUser> numFollowed = UserFollowsUserFacade.findByFollowerandisPermitted(beingFollowed, Boolean.TRUE);
